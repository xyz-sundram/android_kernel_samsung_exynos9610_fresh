...
BUILDVER=V5
BUILDTYPE=ONEUI
DEFCONFIG=exynos9610-a50_fresh_defconfig
...
export CROSS_COMPILE_ARM32=/home/bode/GCC/gcc12-arm-main/bin/arm-eabi-
export CROSS_COMPILE=/home/bode/GCC/gcc_aarch64-elf-12.0.0/bin/aarch64-elf-
export CLANG_TRIPLE=/home/bode/CLANG/clang+llvm-12.0.1/bin/aarch64-linux-gnu-
export CC=/home/bode/CLANG/clang+llvm-12.0.1/bin/clang
...
ln -s $(pwd)/out/include/generated ./include/generated
cp -r ./security/samsung/defex_lsm/cert/*.der ./out/security/samsung/defex_lsm/cert/
cp -r ./firmware/tsp_imagis/* ./out/firmware/tsp_imagis/
make O=out -j$(nproc --all)
$(pwd)/tools/dtb/mkdtboimg cfg_create --dtb-dir=$(pwd) $(pwd)/tools/dtb/dtb.img "$(pwd)/arch/arm64/boot/config/exynos9610-a50.dtb.config"
echo ""
...
make O=out -j$(nproc --all)
$(pwd)/tools/dtb/mkdtboimg cfg_create --dtb-dir=$(pwd) $(pwd)/tools/dtb/dtb.img "$(pwd)/arch/arm64/boot/config/exynos9610-a50.dtb.config"
#$(pwd)/tools/dtb/mkdtboimg cfg_create --dtb-dir=$(pwd) $(pwd)/tools/dtb/dtbo.img "$(pwd)/arch/arm64/boot/config/exynos9610-a50.dtbo.config"
echo ""
echo "Kernel Compiled"
echo ""
rm ./Optimized/AIK/split_img/boot.img-zImage
